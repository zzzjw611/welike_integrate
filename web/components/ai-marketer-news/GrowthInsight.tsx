import type { GrowthInsight } from "@/lib/ai-marketer-news";
import SectionHeader from "./SectionHeader";
import { TrendingUp, ArrowUpRight, Sparkles } from "lucide-react";

export default function GrowthInsightSection({ items }: { items: GrowthInsight[] }) {
  return (
          ...
          >
            ...
            {g.commentary && (
              <div className="mt-5 pt-5 border-t border-surface-800">
                ...
                <p className="text-[14.5px] leading-[1.65] text-surface-200">{g.commentary}</p>
              </div>
            )}
          </article>
        ))}
