  ...
  return (
    <Card>
      ...
      <div className="relative pt-2">
        ...
        <div className="relative mt-2 h-3 rounded-full bg-surface-800">
          <div
            className="absolute inset-y-0 rounded-full bg-gradient-to-r from-brand/40 to-brand"
            style={{ left: "0%", width: "100%" }}
          />
          <div
            className="absolute top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-brand bg-surface-900 shadow-lg shadow-brand/20"
            style={{ left: `${position}%` }}
          />
        </div>
        <p className="mt-3 text-center font-mono text-sm text-surface-400">
